                    ...
                    <SplideTrack>
                        {
                            banners?.map((banner, index) => (
                                <SplideSlide key={index}>
                                    <div style={{ background: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${`http://localhost:3001/api/img/banner/${banner.banner_img}`})`, backgroundRepeat: "no-repeat", backgroundPosition: "center", height: "95vh", backgroundSize: "cover" }}></div>
