import { faBook, faPencil, faPlus, faTrash } from "@fortawesome/free-solid-svg-icons"
                                        ...
                                        data.business_acc === 1 && (
                                            <tr key={index}>
                                                ...
                                                <td className='d-flex justify-content-between align-items-center'>
                                                    <Link title="Üýtgetmek" className='btn btn-sm btn-outline-warning mx-3' to={`/admin/service/edit/${data.id}`}><FontAwesomeIcon icon={faPencil} /></Link>
                                                    <Link title="Biznes hasap açmak" className='btn btn-sm btn-outline-success mx-3' to={`/admin/service/busniss-edit/${data.id}`}><FontAwesomeIcon icon={faBook} /></Link>
                                                    <button title="Pozmak" className='btn btn-sm btn-outline-danger mx-3' onClick={() => handleDelete(data.id)}>
