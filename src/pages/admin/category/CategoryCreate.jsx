...
const CategoryCreate = () => {
    ...
    const handleClick = async (e) => {
        ...
        if (!category.name_tm) {
            ...
            await axios.post(`${import.meta.env.VITE_API_FETCH}/category/create`, formData, {
                headers: {
                            ...
                            <form className='row' onSubmit={handleClick}>
                                ...
                                <div className="col-lg-12 mb-3">
                                    ...
                                    <div className="input-group mb-3">
                                        <input name='category_img' onChange={(e) => setImg(e.target.files[0])} type="file" className="form-control rounded-0" autoComplete="off" />
                                    </div>
                                </div>
